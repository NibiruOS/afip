...
/**
 * <p>Clase Java para ConsultarPtosVtaCAEANoInformadosRequestType complex type.</p>
 *
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.</p>
 *
 * <pre>
 * &lt;complexType name="ConsultarPtosVtaCAEANoInformadosRequestType">
 *   &lt;complexContent>
...
@XmlType(name = "ConsultarPtosVtaCAEANoInformadosRequestType", propOrder = {
        "authRequest",
        "caea"
})
@Root(name = "consultarPtosVtaCAEANoInformadosRequest")
@Namespace(reference = MTXCAServicePortType.SERVICE_NAMESPACE)
public class ConsultarPtosVtaCAEANoInformadosRequestType {
    ...
    public ConsultarPtosVtaCAEANoInformadosRequestType(AuthRequestType authRequest, long caea) {
