...
/**
 * <p>Clase Java para ArrayTiposDocumentoType complex type.</p>
 *
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.</p>
 *
 * <pre>
 * &lt;complexType name="ArrayTiposDocumentoType">
 *   &lt;complexContent>
...
@XmlType(name = "ArrayTiposDocumentoType", propOrder = {
        "codigoDescripcion"
})
public class ArrayTiposDocumentoType {
