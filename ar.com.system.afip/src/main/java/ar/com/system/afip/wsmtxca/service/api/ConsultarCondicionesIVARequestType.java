...
/**
 * <p>Clase Java para ConsultarCondicionesIVARequestType complex type.</p>
 *
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.</p>
 *
 * <pre>
 * &lt;complexType name="ConsultarCondicionesIVARequestType">
 *   &lt;complexContent>
...
@XmlType(name = "ConsultarCondicionesIVARequestType", propOrder = {
        "authRequest"
})
@Root(name = "consultarCondicionesIVARequest")
@Namespace(reference = MTXCAServicePortType.SERVICE_NAMESPACE)
public class ConsultarCondicionesIVARequestType {
    ...
    public ConsultarCondicionesIVARequestType(AuthRequestType authRequest) {
