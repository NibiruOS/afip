...
/**
 * <p>Clase Java para ArrayComprobantesAsociadosType complex type.</p>
 * 
...
public class ArrayComprobantesAsociadosType {
    ...
    @ElementList(name = "ComprobantesAsociados", entry = "comprobanteAsociado", type = ComprobanteAsociadoType.class, inline = true)
