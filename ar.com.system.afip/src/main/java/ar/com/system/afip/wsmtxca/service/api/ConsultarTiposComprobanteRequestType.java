...
/**
 * <p>Clase Java para ConsultarTiposComprobanteRequestType complex type.</p>
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.</p>
 * 
 * <pre>
 * &lt;complexType name="ConsultarTiposComprobanteRequestType">
 *   &lt;complexContent>
...
@XmlType(name = "ConsultarTiposComprobanteRequestType", propOrder = {
    "authRequest"
})
@Root(name = "consultarTiposComprobanteRequest")
@Namespace(reference = MTXCAServicePortType.SERVICE_NAMESPACE)
public class ConsultarTiposComprobanteRequestType {

    @XmlElement(required = true)
    protected AuthRequestType authRequest;

    public ConsultarTiposComprobanteRequestType(AuthRequestType authRequest) {
