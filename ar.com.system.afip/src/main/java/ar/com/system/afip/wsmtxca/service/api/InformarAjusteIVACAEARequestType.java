...
/**
 * <p>Clase Java para InformarAjusteIVACAEARequestType complex type.</p>
 *
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.</p>
 *
 * <pre>
 * &lt;complexType name="InformarAjusteIVACAEARequestType">
 *   &lt;complexContent>
...
@XmlType(name = "InformarAjusteIVACAEARequestType", propOrder = {
        "authRequest",
        "comprobanteCAEARequest"
})
@Root(name = "informarAjusteIVACAEARequest")
@Namespace(reference = MTXCAServicePortType.SERVICE_NAMESPACE)
public class InformarAjusteIVACAEARequestType {
