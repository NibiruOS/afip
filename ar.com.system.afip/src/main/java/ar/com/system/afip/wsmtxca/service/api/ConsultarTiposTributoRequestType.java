...
/**
 * <p>Clase Java para ConsultarTiposTributoRequestType complex type.</p>
 *
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.</p>
 *
 * <pre>
 * &lt;complexType name="ConsultarTiposTributoRequestType">
 *   &lt;complexContent>
...
@XmlType(name = "ConsultarTiposTributoRequestType", propOrder = {
        "authRequest"
})
@Root(name = "consultarTiposTributoRequest")
@Namespace(reference = MTXCAServicePortType.SERVICE_NAMESPACE)
public class ConsultarTiposTributoRequestType {

    @XmlElement(required = true)
    @Element
    protected AuthRequestType authRequest;

    public ConsultarTiposTributoRequestType(AuthRequestType authRequest) {
