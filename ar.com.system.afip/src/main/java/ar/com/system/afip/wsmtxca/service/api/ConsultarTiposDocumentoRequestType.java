...
/**
 * <p>Clase Java para ConsultarTiposDocumentoRequestType complex type.</p>
 *
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.</p>
 *
 * <pre>
 * &lt;complexType name="ConsultarTiposDocumentoRequestType">
 *   &lt;complexContent>
...
@XmlType(name = "ConsultarTiposDocumentoRequestType", propOrder = {
        "authRequest"
})
@Root(name = "consultarTiposDocumentoRequest")
@Namespace(reference = MTXCAServicePortType.SERVICE_NAMESPACE)
public class ConsultarTiposDocumentoRequestType {

    @XmlElement(required = true)
    @Element
    protected AuthRequestType authRequest;

    public ConsultarTiposDocumentoRequestType(AuthRequestType authRequest) {
