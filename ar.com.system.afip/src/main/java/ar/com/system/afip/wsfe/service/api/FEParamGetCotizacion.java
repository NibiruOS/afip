...
@Root(name = "FEParamGetCotizacion")
...
public class FEParamGetCotizacion {
    ...
    public FEParamGetCotizacion() {
    }

    public FEParamGetCotizacion(@Nonnull FEAuthRequest auth,
                                @Nonnull String monId) {
        this.auth = checkNotNull(auth);
        this.monId = checkNotNull(monId);
    }
