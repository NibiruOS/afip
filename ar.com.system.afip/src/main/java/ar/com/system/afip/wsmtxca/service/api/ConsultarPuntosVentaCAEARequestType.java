...
/**
 * <p>Clase Java para ConsultarPuntosVentaCAEARequestType complex type.</p>
 *
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.</p>
 *
 * <pre>
 * &lt;complexType name="ConsultarPuntosVentaCAEARequestType">
 *   &lt;complexContent>
...
@XmlType(name = "ConsultarPuntosVentaCAEARequestType", propOrder = {
        "authRequest"
})
@Root(name = "consultarPuntosVentaCAEARequest")
@Namespace(reference = MTXCAServicePortType.SERVICE_NAMESPACE)
public class ConsultarPuntosVentaCAEARequestType {

    @XmlElement(required = true)
    @Element
    protected AuthRequestType authRequest;

    public ConsultarPuntosVentaCAEARequestType(AuthRequestType authRequest) {
