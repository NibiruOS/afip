...
import ar.com.system.afip.wsaa.service.api.LoginCmsRequest;
...
public class BouncyCastleWsaaManager implements WsaaManager {
    ...
    @Inject
    public BouncyCastleWsaaManager(@Nonnull WsaaDao wsaaDao,
                                   @Nonnull SetupDao setupDao,
                                   @Nonnull LoginCMS loginCms,
    ...
    public Credentials login(Service service) {
        try {
            ...
            String loginTicketResponseXml = loginCms
                    .loginCms(new LoginCmsRequest(cms))
                    .getLoginCmsReturn();

            LoginTicketResponse response = serializer
                    .read(LoginTicketResponse.class, loginTicketResponseXml);
