...
public class LoginTicketRequest {
    public static LoginTicketRequest create(String source, Service service, String environment) {
        ...
        return new LoginTicketRequest(
                new Header(source,
                        ...
                        new Long(generation.getTime().getTime() / 1000),
                        generation.getTime(),
                        expiration.getTime()),
    ...
    public Xml toXml(XmlMapper xmlMapper) {
        return new Xml(xmlMapper);
    }

    public class Xml {
        private final XmlMapper xmlMapper;

        private Xml(XmlMapper xmlMapper) {
        ...
        public String toString() {
            try {
                return xmlMapper.writeValueAsString(LoginTicketRequest.this);
